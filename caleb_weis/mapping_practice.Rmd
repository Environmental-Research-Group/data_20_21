...
The next bit of code is from the website "https://www.illinoistech.org/news/455137/Making-Interactive-Maps-of-Public-Data-in-R.htm".
...
leaflet() %>%
  addTiles() %>%
  addPolygons(data = zip_code_boundaries_sf, color = "red", 
              weight = 1.5, opacity = 1, fillColor = "black", 
              fillOpacity = 0.6, highlightOptions = 
